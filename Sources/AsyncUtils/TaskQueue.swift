...
public actor TaskQueue {
    ...
    /// Invocations are serialized: The closure is never called concurrently with itself. Once it returns, it will be called again as long as the queue remains empty and free slots are available.
